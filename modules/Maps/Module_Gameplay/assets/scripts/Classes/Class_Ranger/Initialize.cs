function Class_Ranger_AOE_Sensor::onCollision(%this,%Colliding_Object,%Collision_Details)
{
...
function Class_Ranger_AOE_Sensor::onEndCollision(%this,%Colliding_Object,%Collision_Details)
{
...
function Class_Ranger_AOE_Sensor::onRemove(%this)
{
...
function Class_Ranger::Initialize(%this)
{

%Vector_2D_Size=%this.Size.X*8 SPC %this.Size.Y*8;

%this.SceneObject_AOE_Sensor=new SceneObject()
{

Class="Class_Ranger_AOE_Sensor";
