function Module_Gameplay::Floor_Detail_Initialize(%this)
{
...
if (getRandom(0,20)){continue;}

%ScriptObject_String_Floor_Tile=Module_Forest.SimSet_String_Floor_Detail_Tiles.getObject(getRandom(0,Module_Forest.SimSet_String_Floor_Detail_Tiles.getCount()-1));
