...
%Size.X=(%Size.X*Carambola.Resolution.X)/%Ass.Optimal_Resolution.X;

%Size.Y=(%Size.Y*Carambola.Resolution.Y)/%Ass.Optimal_Resolution.Y;
...
%Size.X=(%Size.X*Carambola.Camera_Size.X)/Carambola.Resolution.X;

%Size.Y=(%Size.Y*Carambola.Camera_Size.Y)/Carambola.Resolution.Y;
...
%Vector_2D_Scaled.X-=Carambola.Resolution.X/2;//offset cus cam is from -50 to 50

%Vector_2D_Scaled.Y-=Carambola.Resolution.Y/2;//offset cus cam is from -30 to 30

%Vector_2D_Scaled.Y=-%Vector_2D_Scaled.Y;//flip cus -y is down and +y is up

%Vector_2D_Scaled.X=(%Vector_2D_Scaled.X*Carambola.Camera_Size.X)/Carambola.Resolution.X;

%Vector_2D_Scaled.Y=(%Vector_2D_Scaled.Y*Carambola.Camera_Size.Y)/Carambola.Resolution.Y;
...
%Vector_2D_Scaled.X=(%Vector_2D_Scaled.X*Carambola.Resolution.X)/%Vector_2D_Resolution.X;

%Vector_2D_Scaled.Y=(%Vector_2D_Scaled.Y*Carambola.Resolution.Y)/%Vector_2D_Resolution.Y;
...
%Vector_2D.X=(%Vector_2D.X*Carambola.Camera_Size.X)/Carambola.Resolution.X;

%Vector_2D.Y=(%Vector_2D.Y*Carambola.Camera_Size.Y)/Carambola.Resolution.Y;
...
%Vector_2D.X=(%Vector_2D.X*Carambola.Resolution.X)/%Vector_2D_Resolution.X;

%Vector_2D.Y=(%Vector_2D.Y*Carambola.Resolution.Y)/%Vector_2D_Resolution.Y;
...
%Vector_2D.X=(%Vector_2D.X*Carambola.Resolution.X)/Carambola.Camera_Size.X;

%Vector_2D.Y=(%Vector_2D.Y*Carambola.Resolution.Y)/Carambola.Camera_Size.Y;
